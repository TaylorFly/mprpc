...
class GetFriendListsResp;
struct GetFriendListsRespDefaultTypeInternal;
extern GetFriendListsRespDefaultTypeInternal _GetFriendListsResp_default_instance_;
class ResultCode;
struct ResultCodeDefaultTypeInternal;
extern ResultCodeDefaultTypeInternal _ResultCode_default_instance_;
}  // namespace fixbug
PROTOBUF_NAMESPACE_OPEN
template<> ::fixbug::GetFriendListsReq* Arena::CreateMaybeMessage<::fixbug::GetFriendListsReq>(Arena*);
template<> ::fixbug::GetFriendListsResp* Arena::CreateMaybeMessage<::fixbug::GetFriendListsResp>(Arena*);
...
class GetFriendListsReq final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetFriendListsReq) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetFriendListsReq";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetFriendListsReq)
 private:
  class _Internal;
...
class GetFriendListsResp final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetFriendListsResp) */ {
 public:
  inline GetFriendListsResp() : GetFriendListsResp(nullptr) {}
  ~GetFriendListsResp() override;
  explicit PROTOBUF_CONSTEXPR GetFriendListsResp(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  GetFriendListsResp(const GetFriendListsResp& from);
  GetFriendListsResp(GetFriendListsResp&& from) noexcept
    : GetFriendListsResp() {
    *this = ::std::move(from);
  }

  inline GetFriendListsResp& operator=(const GetFriendListsResp& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetFriendListsResp& operator=(GetFriendListsResp&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const GetFriendListsResp& default_instance() {
    return *internal_default_instance();
  }
  static inline const GetFriendListsResp* internal_default_instance() {
    return reinterpret_cast<const GetFriendListsResp*>(
               &_GetFriendListsResp_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  friend void swap(GetFriendListsResp& a, GetFriendListsResp& b) {
    a.Swap(&b);
  }
  inline void Swap(GetFriendListsResp* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(GetFriendListsResp* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  GetFriendListsResp* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<GetFriendListsResp>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const GetFriendListsResp& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const GetFriendListsResp& from) {
    GetFriendListsResp::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetFriendListsResp* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetFriendListsResp";
  }
  protected:
  explicit GetFriendListsResp(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetFriendListsResp)
 private:
  class _Internal;
...
inline uint32_t GetFriendListsReq::userid() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsReq.userid)
...
inline void GetFriendListsReq::set_userid(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListsReq.userid)
}
...
// .fixbug.ResultCode result = 1;
inline bool GetFriendListsResp::_internal_has_result() const {
  return this != internal_default_instance() && _impl_.result_ != nullptr;
}
inline bool GetFriendListsResp::has_result() const {
  return _internal_has_result();
}
inline void GetFriendListsResp::clear_result() {
  if (GetArenaForAllocation() == nullptr && _impl_.result_ != nullptr) {
    delete _impl_.result_;
  }
  _impl_.result_ = nullptr;
}
inline const ::fixbug::ResultCode& GetFriendListsResp::_internal_result() const {
...
inline const ::fixbug::ResultCode& GetFriendListsResp::result() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsResp.result)
  return _internal_result();
}
inline void GetFriendListsResp::unsafe_arena_set_allocated_result(
    ::fixbug::ResultCode* result) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.GetFriendListsResp.result)
}
inline ::fixbug::ResultCode* GetFriendListsResp::release_result() {
...
inline ::fixbug::ResultCode* GetFriendListsResp::unsafe_arena_release_result() {
  // @@protoc_insertion_point(field_release:fixbug.GetFriendListsResp.result)
  
  ::fixbug::ResultCode* temp = _impl_.result_;
  _impl_.result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* GetFriendListsResp::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* GetFriendListsResp::mutable_result() {
  ::fixbug::ResultCode* _msg = _internal_mutable_result();
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsResp.result)
  return _msg;
}
inline void GetFriendListsResp::set_allocated_result(::fixbug::ResultCode* result) {
  ...
  _impl_.result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetFriendListsResp.result)
}

// repeated bytes friends = 2;
inline int GetFriendListsResp::_internal_friends_size() const {
  return _impl_.friends_.size();
}
inline int GetFriendListsResp::friends_size() const {
  return _internal_friends_size();
}
inline void GetFriendListsResp::clear_friends() {
  _impl_.friends_.Clear();
}
inline std::string* GetFriendListsResp::add_friends() {
  std::string* _s = _internal_add_friends();
  // @@protoc_insertion_point(field_add_mutable:fixbug.GetFriendListsResp.friends)
  return _s;
}
inline const std::string& GetFriendListsResp::_internal_friends(int index) const {
  return _impl_.friends_.Get(index);
}
inline const std::string& GetFriendListsResp::friends(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsResp.friends)
  return _internal_friends(index);
}
inline std::string* GetFriendListsResp::mutable_friends(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsResp.friends)
  return _impl_.friends_.Mutable(index);
}
inline void GetFriendListsResp::set_friends(int index, const std::string& value) {
  _impl_.friends_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListsResp.friends)
}
inline void GetFriendListsResp::set_friends(int index, std::string&& value) {
  _impl_.friends_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:fixbug.GetFriendListsResp.friends)
}
inline void GetFriendListsResp::set_friends(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.friends_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:fixbug.GetFriendListsResp.friends)
}
inline void GetFriendListsResp::set_friends(int index, const void* value, size_t size) {
  _impl_.friends_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:fixbug.GetFriendListsResp.friends)
}
inline std::string* GetFriendListsResp::_internal_add_friends() {
  return _impl_.friends_.Add();
}
inline void GetFriendListsResp::add_friends(const std::string& value) {
  _impl_.friends_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListsResp.friends)
}
inline void GetFriendListsResp::add_friends(std::string&& value) {
  _impl_.friends_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListsResp.friends)
}
inline void GetFriendListsResp::add_friends(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.friends_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:fixbug.GetFriendListsResp.friends)
}
inline void GetFriendListsResp::add_friends(const void* value, size_t size) {
  _impl_.friends_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:fixbug.GetFriendListsResp.friends)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
GetFriendListsResp::friends() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListsResp.friends)
  return _impl_.friends_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
GetFriendListsResp::mutable_friends() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListsResp.friends)
  return &_impl_.friends_;
}
